# AUTOGENERATED! DO NOT EDIT! File to edit: notebooks/30_hotmax.ipynb (unless otherwise specified).

__all__ = ['get_hotmax', 'get_baseline', 'get_noiseline', 'get_envelopes']
